...
meal1 = 
    Meal.create(
        ...
        image:"https://media1.westword.com/den/imager/u/blog/13405699/20220203_193214.jpg?cb=1644524189", 
        price: 56.00,
...
meal2 = 
    Meal.create(
        name: "The Rancher",
        image:"https://d30ec9yrj6srx8.cloudfront.net/f3aa3eed391a01276962815b05594825_file.jpeg", price: 17.00,
...
meal3 = 
    Meal.create(
        name: "Bangkok Ribs",
        image:"https://imagedelivery.net/9lr8zq_Jvl7h6OFWqEi9IA/49e013ca-9b39-4a5b-e132-33fd9eac6100/public", 
        price: 32.00,
...
meal5 = 
    Meal.create(
        name: "The Trio",
        image:"https://img2.10bestmedia.com/Images/Photos/284844/p-Machete-Plate-Drink_55_660x440.jpg", 
        price: 16.00,
...
meal6 = 
    Meal.create(
        name: "Surf and Turf",
        image:"https://cdn.vox-cdn.com/thumbor/PKmrJC3s8AwjXkQGO0iuiI6-uag=/0x0:1913x1303/920x613/filters:focal(804x499:1110x805):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/63199235/oceanprime.0.png", 
        price: 47.50,
...
meal7 = 
    Meal.create(
        ...
        image:"https://s3-media0.fl.yelpcdn.com/bphoto/rdh633cO07n-Y9aGQgMwaA/o.jpg", 
        price: 26.00,
...
meal8 = 
    Meal.create(
        name: "Tonkutsu Ramen",
        image:"http://www.bittermansguide.com/uploads/1/1/2/3/112331721/img-6661-orig_orig.jpg", 
        price: 19.00,
...
meal9 = 
    Meal.create(
        name: "Tofu Scramble",
        image:"https://images.happycow.net/venues/200x200/52/01/hcmp52012_1167013.jpeg", 
        price: 20.00,
...
meal10 = 
    Meal.create(
        name: "Lobster Roll",
        image:"https://assets.website-files.com/5bd78ffdfc757ce771e4bf46/5dad3a7706d077927ce795e0_LOBSTER_ROLL_01s.jpg", 
        price: 25.00,
        restaurant_id: resto1.id
    )
meal11 = 
    Meal.create(
        name: "Avocado Toast",
        image:"https://images.happycow.net/venues/1024/24/95/hcmp24954_463724.jpeg", 
        price: 19.00,
        restaurant_id: resto9.id
    )
meal12 = 
    Meal.create(
        ...
        image:"https://hot-thai-kitchen.com/wp-content/uploads/2014/02/Pineapple-fried-rice-sq-2.jpg", 
        price: 23.50,
        restaurant_id: resto3.id
    )
